...
[![Build Status](https://travis-ci.org/iarna/promisable-bluebird.svg?branch=master)](https://travis-ci.org/iarna/promisable-bluebird)

Promisables implemented using Bluebird

Making Promises
---------------

    var Promisable = require('promisable-bluebird');
...
This is cut down version of the excellent Bluebird promise module, modified
to match the Promisable API.  It differs from Bluebird, and other promise
implementations as follows:

* Errors have to be handled or they'll be thrown.
* Core from Bluebird for speed and memory advantages.
...
This module is a fork of https://www.npmjs.org/package/bluebird which is the
awesome work of Petka Antonov.

Bugs are likely mine, the speed and tiny memory use are bluebirds.

It's been modified to have the interface provided by
https://www.npmjs.org/package/promisable All other features have been removed.

Tests are from promisable.
